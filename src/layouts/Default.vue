  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="top-0 left-0 z-40 fixed w-full border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/" @click.native="scrollToTop" style="border-bottom: none;">
            <g-image src="../../static/favicon.svg" class="w-10" alt="logo" style="display: inline-block;" /><span style="display: inline-block; margin-left: 10px; font-size: 20px;">ABC-SALE</span>
          </g-link>
